...
from tasks.twitter_tasks import retrieve_user_info_by_id, retrieve_user_info_by_username, \
    retrieve_users_info_by_ids, tweet_puller_archive, tweet_puller_stream
...
def stream_search():
    ...
    tweet_puller_stream.apply_async((query_param, None, start_param, end_param,), countdown=3.5)
    session.close()
