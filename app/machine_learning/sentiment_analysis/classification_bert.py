...
# %%
TRAIN(one_million_model, one_million_model_5)
print("TESTING #5")
model = load_model(one_million_model_5.model_file)
...
TRAIN(one_million_model_5, one_million_model_6)
print("TESTING #6")
model = load_model(one_million_model_6.model_file)
test_model(model, ian_dataset_config)
test_model(model, aidan_dataset_config)
test_model(model, nick_dataset_config)
test_model(model, nathan_dataset_config)
test_model(model, tdm_dataset_config)
TRAIN(one_million_model_6, one_million_model_7)
print("TESTING #7")
model = load_model(one_million_model_7.model_file)
test_model(model, ian_dataset_config)
test_model(model, aidan_dataset_config)
test_model(model, nick_dataset_config)
test_model(model, nathan_dataset_config)
