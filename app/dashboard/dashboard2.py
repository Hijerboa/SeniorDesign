...
def _getNavbar(searchArea):  # TODO: Change icon to somehting else, add twitter links, remove search bar, make responsive dropdown open alternate search, make navbar toggler switch at proper screen size.
...
def _getOffCanvas(searchArea):  # TODO: Fill with bill search elements
...
class Server:
    def __init__(self) -> None:
        ...
        self.app = dash.Dash(__name__, external_stylesheets=[
                             dbc.themes.QUARTZ, dbc.icons.BOOTSTRAP, "https://use.fontawesome.com/releases/v6.1.1/css/all.css", dbc_css])

        # Build main app layout
        searchArea = _makeSearchArea()
        self.app.layout = html.Div(children=[
            _getNavbar(searchArea),  # Get the navbar elements and place into the layout above the main container
